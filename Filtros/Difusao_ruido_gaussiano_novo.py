...
def processo_ruido():
    ...
    for folder in os.listdir(raiz):
        ...
        for file in files:
            ...
            gaussino=difusao_anisotropica(sementes)
            ...
            # cv2.imwrite("E:/Dissertacao/RuidoGaussiano/Imagens/Difusao_ruido/"+str(folder)+"/"+str(file) + ".bmp", gaussino)
            ...
            with open('E:/Dissertacao/RuidoGaussiano/Metrica1/Difusao_ruido/'+str(folder)+'/psnr/'+str(file)+'.txt','w') as arq2:
                arq2.write(str(d))
            del(arq2)
            with open('E:/Dissertacao/RuidoGaussiano/Metrica1/Difusao_ruido/'+str(folder)+'/mse/'+str(file)+'.txt','w') as arq2:
                arq2.write(str(d1))
            del(arq2)
            with open('E:/Dissertacao/RuidoGaussiano/Metrica1/Difusao_ruido/'+str(folder)+'/ssim/'+str(folder)+str(file)+'.txt','w') as arq2:
                arq2.write(str(d2))
            del(arq2) 
...
def ler():
    ...
    for folder in os.listdir(raiz):
        ...
        for file in files:
            ...
            plt.title("a")
            plt.show()
            cv2.imwrite("E:/Dissertacao/RuidoGaussiano/Imagens/Difusao/"+str(folder)+"/"+str(file) + ".bmp", gaussino)
            d1 = np.mean((imgROI - gaussino) ** 2, dtype=np.float64)
            d = 10 * np.log10((255 ** 2) / d1)
            d2 = ssim4(imgROI.astype(np.uint8), gaussino.astype(np.uint8),multichannel=True)
            
            with open('E:/Dissertacao/RuidoGaussiano/Metrica1/Difusao/'+str(folder)+'/psnr/'+str(file)+'.txt','w') as arq2:
                arq2.write(str(d))
            del(arq2)
            with open('E:/Dissertacao/RuidoGaussiano/Metrica1/Difusao/'+str(folder)+'/mse/'+str(file)+'.txt','w') as arq2:
                arq2.write(str(d1))
            del(arq2)
            with open('E:/Dissertacao/RuidoGaussiano/Metrica1/Difusao/'+str(folder)+'/ssim/'+str(folder)+str(file)+'.txt','w') as arq2:
                arq2.write(str(d2))
            del(arq2) 
