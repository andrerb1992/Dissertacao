# -*- coding: utf-8 -*-
"""
Created on Wed Apr 22 00:27:35 2020
...
def ler():
    ...
    for folder in os.listdir(raiz):
        ...
        for file in files:
            ...
            with open('E:/Dissertacao/Resultados_Metricas/Filtro1/Gaussiano/'+str(folder)+'/psnr/'+str(file)+'.txt','w') as arq2:
                arq2.write(str(d))
            del(arq2)
            with open('E:/Dissertacao/Resultados_Metricas/Filtro1/Gaussiano/'+str(folder)+'/mse/'+str(file)+'.txt','w') as arq2:
                arq2.write(str(d1))
            del(arq2)
            # with open('E:/Dissertacao/Resultados_Metricas/Filtro1/Gaussiano/'+str(folder)+'/ssim/'+str(folder)+str(file)+'.txt','w') as arq2:
            #     arq2.write(str(d2))
            # del(arq2)  
...
#            
            ...
            with open('E:/Dissertacao/Resultados_Metricas/Filtro1/Gaussiano_ruido/'+str(folder)+'/psnr/'+str(file)+'.txt','w') as arq2:
                arq2.write(str(d))
            del(arq2)
            with open('E:/Dissertacao/Resultados_Metricas/Filtro1/Gaussiano_ruido/'+str(folder)+'/mse/'+str(file)+'.txt','w') as arq2:
                arq2.write(str(d1))
            del(arq2)
            # with open('E:/Dissertacao/Resultados_Metricas/Filtro1/Gaussiano_ruido/'+str(folder)+'/ssim/'+str(folder)+str(file)+'.txt','w') as arq2:
            #     arq2.write(str(d2))
            # del(arq2)  
