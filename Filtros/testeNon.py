...
def ler():
    ...
    for folder in os.listdir(raiz):
        ...
        for file in files:
            ...
            gaussino=filter_nonlocal_means(sementes)
            ...
            plt.title("imagem")
            plt.show()
            cv2.imwrite("E:/Dissertacao/Imagens/Non_Local_Means_Imagem_Original/"+str(folder)+"/"+str(file) + ".bmp", gaussino)
            ...
            gaussino_ruido=filter_nonlocal_means(salEpimenta1)            
...
#            
            ...
            cv2.imwrite("E:/Dissertacao/Imagens/Non_Local_Means_Imagem_ruido/"+str(folder)+"/"+str(file) + ".bmp", gaussino_ruido)
...
#            nonlocal_means=filter_nonlocal_means1(sementes)
#            nonlocal_means=cv2.bitwise_and(nonlocal_means,nonlocal_means,mask=img1)
#            print(nonlocal_means)
#            nonlocal_means = cv2.cvtColor(nonlocal_means, cv2.COLOR_BGR2GRAY)
#            nonlocal_means = nonlocal_means[550:3400,550:3400]
#            plt.imshow(nonlocal_means,'gray')
#            plt.title("b")
#            plt.show()
...
#            
#            with open('E:/Filtro/Non_local_means1/'+str(folder)+'/psnr/'+str(file)+'.txt','w') as arq2:
#                arq2.write(str(d))
#            del(arq2)
#            with open('E:/Filtro/Non_local_means1/'+str(folder)+'/mse/'+str(file)+'.txt','w') as arq2:
#                arq2.write(str(d1))
#            del(arq2)
#            with open('E:/Filtro/Non_local_means1/'+str(folder)+'/ssim/'+str(folder)+str(file)+'.txt','w') as arq2:
#                arq2.write(str(d2))
#            del(arq2)  
#            
#            nonlocal_means_ruido=filter_nonlocal_means1(salEpimenta1) 
#            nonlocal_means_ruido=cv2.bitwise_and(nonlocal_means_ruido,nonlocal_means_ruido,mask=img1)
#            nonlocal_means_ruido = cv2.cvtColor(nonlocal_means_ruido, cv2.COLOR_BGR2GRAY)     
#            
#            nonlocal_means_ruido = nonlocal_means_ruido[550:3400,550:3400]
#            plt.imshow(nonlocal_means_ruido,'gray')
#            plt.show()
#            
#            
...
#            
#            with open('E:/Filtro/Non_local_means_ruido1/'+str(folder)+'/psnr/'+str(file)+'.txt','w') as arq2:
#                arq2.write(str(d))
#            del(arq2)
#            with open('E:/Filtro/Non_local_means_ruido1/'+str(folder)+'/mse/'+str(file)+'.txt','w') as arq2:
#                arq2.write(str(d1))
#            del(arq2)
#            with open('E:/Filtro/Non_local_means_ruido1/'+str(folder)+'/ssim/'+str(folder)+str(file)+'.txt','w') as arq2:
#                arq2.write(str(d2))
#            del(arq2)  
#               
